...
const DeleteAccount: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Your request has been submitted. We will contact you shortly to confirm the deletion process.",
    );
    setFormData({
      name: "",
      phone: "",
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4 text-slate-700">
            Account Deletion Request
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            To delete your TrueVisual account, please fill out the form below
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Data Export Request">
                    Data Export Request
                  </option>
