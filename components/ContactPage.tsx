...
const ContactPage: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://es.technoboost.in/api/v1/mail-send", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({
          token: "gUXMeJn%P8gRVxYEH",
          emailSubjectLine: "Get in touch",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-12 leading-relaxed">
              Have questions about our platform or need a custom solution? We're
              here to help you redefine trust in your operations.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div className="ml-6">
                  ...
                  <a
                    href="mailto:puneet@truevisual.io"
                    className="text-brand-600 font-medium hover:underline"
                  >
                    puneet@truevisual.io
                  </a>
                </div>
              </div>
